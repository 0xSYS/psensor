...
|                 	| udisks2                     	| -                    	|                                                                      	|
|                 	| libatasmart                 	| -                    	|                                                                      	|
|                 	| libxnvctrl                    | -                     | Provides hardware information for NVidia gpu's                        |
|                 	| vala                          | -                     | Build dependency required by libunity                                 |
...
> [!NOTE]
> libunity is not provided as default package to install and it requires package build to be made.
> libunity also requires dee to be build and installed
>
> Steps:
> 1. `git clone https://aur.archlinux.org/dee.git`
> 2. `cd dee`
> 3. makepkg -si
> 4. `git clone https://aur.archlinux.org/libunity.git`
> 5. `cd libunity`
> 6. `makepkg -si`
