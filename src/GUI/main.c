/*
 * Copyright (C) 2010-2024 jeanfi@gmail.com
...
static void tests()
{
	...
	// int GetFanPwm = psensor_get_last_pwm("/sys/class/hwmon/hwmon4/pwm1");

	// printf("from main: get last pwm: %d\n", GetFanPwm);
